    ...
    <div className="main-page">
      ...
      <FormGroup className="container">
        ...
        <div className="form-group my-3 main-page">
          ...
          />
          <br />
          <span> {errorData.errusername} </span> <br />
          <select
            onChange={userChange}
            value={gender}
            name="gender"
          ...
          />
          <br />
          <span> {errorData.errphone} </span> <br />
          <label>E-mail:</label>
          <input
            value={email}
            onChange={(e) => {
          ...
          />
          <br />
          <span> {errorData.erremail} </span> <br />
          ...
          />
          <br />
          <span> {errorData.errpassword} </span> <br />
          <button
            type="submit"
            onClick={sumbit}
